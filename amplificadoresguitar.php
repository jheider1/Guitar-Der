...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title>Amplificadores para GUITARRAS - Guitar Der</title>
  ...
  <body>
    ...
    <div class="titulo">
                    <h2>Amplificadores para guitarra</h2>
                    <hr>
                </div>
    ...
    <!--<div class="alertPostAgregado text-center">
        ...
        $sentencia = $pdo -> prepare("SELECT * FROM `productos` WHERE status = 1 and tipo = 'Amplificadores para guitarra'");
        $sentencia -> execute();
