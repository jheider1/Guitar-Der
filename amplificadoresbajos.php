...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title>Amplificadores para BAJOS - Guitar Der</title>
  ...
  <body>
    ...
    <div class="card">
                <div class="titulo">
                    <h2>Amplificadores para bajos </h2>
                    <hr>
                </div>
...
<!--<div class="alertPostAgregado text-center">
    ...
    <section class="proinicio flex text-center" >
        ...
        $sentencia = $pdo -> prepare("SELECT * FROM `productos` WHERE status = 1 and tipo = 'Amplificadiores para bajo'");
        $sentencia -> execute();
