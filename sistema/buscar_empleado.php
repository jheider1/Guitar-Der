...
<body>
	...
	<section id="container">
		...
		<table>
			...
			$sql_registe = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM empleados WHERE (idUsuario LIKE '%$busqueda%' OR cedula LIKE '%$busqueda%' OR nombres LIKE '%$busqueda%' OR apellidos LIKE '%$busqueda%' OR correo LIKE '%$busqueda%' OR telefono LIKE '%$busqueda%' OR genero LIKE '%$busqueda%' $rol) AND status = 1");
