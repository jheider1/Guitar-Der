...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form action="buscar_productos_i" method="get" class="form_search">
    ...
    <table class="tabla_lista_empleados">
      ...
      <?php 
      //paginador
      $sql_registe = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM productos WHERE status = 0 ORDER BY idProductos DESC");
      ...
      $total_paginas = ceil($total_registro / $por_pagina);
        ...
        $query = mysqli_query($conection, "SELECT * FROM productos p WHERE status = 0 ORDER BY idProductos DESC LIMIT $desde,$por_pagina" );
      ...
      <tbody>
        <tr>
          ...
          <td data-titulo="imagen" class="img_producto"><img style="height: 100px" src="<?php echo $foto; ?>"></td>
