	...
	<section id="container">
      ...
      <a href="reporte_ventas" class="btn_desc">Descargar reporte</a>
		...
		<table>
			...
			$sql_registe = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM factura WHERE (noFactura LIKE '%$busqueda%' OR fecha LIKE '%$busqueda%' OR idCliente LIKE '%$busqueda%' OR correoCliente LIKE '%$busqueda%' OR metodoPago LIKE '%$busqueda%' OR totalFactura) AND status = 'Pendiente'");
			...
			$total_paginas = ceil($total_registro / $por_pagina);
				...
				$query = mysqli_query($conection, "SELECT * FROM factura WHERE (noFactura LIKE '%$busqueda%' OR 
																				...
																				AND 
																				status = 'Pendiente' ORDER BY noFactura DESC LIMIT $desde,$por_pagina");
				mysqli_close($conection);
