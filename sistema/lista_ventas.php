...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div>
      ...
      <a href="reporte_ventas" class="btn_desc">Descargar reporte</a>
    </div>
    <form action="buscar_venta" method="get" class="form_search">
      <input class="buscar" type="text" name="busqueda" id="busqueda" placeholder="Buscar">
      <input type="submit" value="Buscar" class="btn_search">
    </form>
    <!--<a href="nueva_venta" class="btn_new_venta">Nueva venta</a>-->
    <table class="tabla_lista_productos">
      ...
      <?php 
      //paginador
      $sql_registe = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM factura WHERE status = 'Pendiente' ORDER BY noFactura DESC");
      ...
      $total_paginas = ceil($total_registro / $por_pagina);
        ...
        $query = mysqli_query($conection, "SELECT * FROM factura WHERE status = 'Pendiente' ORDER BY noFactura DESC LIMIT $desde,$por_pagina" );
