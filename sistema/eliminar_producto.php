...
session_start();
	...
	if (!empty($_POST)) {
		...
		$query_delete = mysqli_query($conection, "UPDATE productos SET status = 0 WHERE idProductos= $idproducto");
...
<head>
	<meta charset="UTF-8">
	<title>Eliminar producto - Clothes For Me</title>
...
<body>
	...
	<section id="container">
		<div class="data_delete">
			...
			<p>Imagen: <span><img style="height: 100px" src="<?php echo $foto; ?>"></td></span></p>
