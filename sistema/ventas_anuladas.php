...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div>
      ...
      <a href="ventas_entregadas" class="btn_inac">Ventas entregadas</a>
      <a href="lista_ventas" class="btn_inac">Ventas pendientes</a>
      <a href="reporte_ventas_a" class="btn_desc">Descargar reporte</a>
    </div>
    <form action="buscar_venta_a" method="get" class="form_search">
    ...
    <table class="tabla_lista_productos">
      ...
      <?php 
      //paginador
      $sql_registe = mysqli_query($conection,"SELECT COUNT(*) as total_registro FROM factura WHERE status = 'Anulado' ORDER BY noFactura DESC");
      ...
      $total_paginas = ceil($total_registro / $por_pagina);
        ...
        $query = mysqli_query($conection, "SELECT * FROM factura WHERE status = 'Anulado' ORDER BY noFactura DESC LIMIT $desde,$por_pagina" );
      ...
      <tbody>
        <tr>
          ...
          <td data-titulo="ACCIÓN">
            ...
            <span> | </span>
            <a class="link_delete" href="pendiente_venta?id=<?php echo $data['noFactura']; ?>">Pendiente </a>
