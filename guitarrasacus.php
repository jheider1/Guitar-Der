...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <title>Guitarras ACÚSTICAS - Guitar Der</title>
  ...
  <body>
    ...
    <section class="proinicio flex text-center" >
        ...
        $sentencia = $pdo -> prepare("SELECT * FROM `productos` WHERE status = 1 and tipo = 'Guitarras acusticas'");
        $sentencia -> execute();
